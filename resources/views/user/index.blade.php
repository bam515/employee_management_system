@extends('user.layout')
@section('content')
<div class="bg-white position-absolute top-50 start-50 translate-middle" style="width: 1000px; height: 600px;">
    <h3 class="position-absolute top-50 start-50 translate-middle">직원 관리 시스템</h3>
