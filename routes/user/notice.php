...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('api')->group(function () {
        ...
        // 공지사항 댓글 수정
        Route::put('/v1/comment/{comment}', [NoticeController::class, 'updateComment'])
            ->name('user.notice.comment.update');

        // 공지사항 댓글 삭제
        Route::delete('/v1/comment/{comment}', [NoticeController::class, 'deleteComment'])
            ->name('user.notice.comment.delete');
    });
});
